...
class CourseListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = ['title', 'slug', 'host', 'cover', 'playlist_count',
...
class PlaylistSimpleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Playlist
        fields = ['order', 'title', 'slug', 'short_uuid', 'product_count',
...
class PlaylistSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['order', 'title', 'slug', 'short_uuid', 'course',
                  'product_count', 'cover', 'created_at', 'updated_at']
...
class CourseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'title', 'slug', 'host', 'cover', 'playlists',
                  'playlist_count', 'created_at', 'updated_at']
